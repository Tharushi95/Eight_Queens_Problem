...
public class EightQueensProblem {
	...
	public static void main(String[] args) {
		...
		while (climb) {
			EightQueensProblem board = new EightQueensProblem(new int[Total_Queens][Total_Queens], new int[8]);
			...
			board.printBoard();
			System.out.println("Number of pairs of queens attacking queens: "
					+ board.h() + "\n");
			...
			for (int j = 0; j < board.board.length; j++) {
				...
				if (best) {
					...
					System.out.println("Best board found in this iteration: ");
					board.printBoard();
					System.out
							.println("Number of pairs of queens attacking queens: "
									+ board.h() + "\n");
				} else {
					...
					System.out
						...
						if(finalCost == 0 ){
							System.out.println("");
							System.out.println("Global Maximum has occured");
						}else{
							System.out.println("");
							System.out.println("Local Maximum has occured");
						}
									}
									}
			}
	...
	public EightQueensProblem(int[][] board, int[] positions) {
